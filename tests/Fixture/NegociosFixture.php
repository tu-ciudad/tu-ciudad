...
class NegociosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'lugares_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'perfilfb' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'fk_negocios_lugares_idx' => ['type' => 'index', 'columns' => ['lugares_id'], 'length' => []],
            'fk_negocios_users1_idx' => ['type' => 'index', 'columns' => ['users_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id', 'users_id'], 'length' => []],
            'fk_negocios_lugares' => ['type' => 'foreign', 'columns' => ['lugares_id'], 'references' => ['lugares', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_negocios_users1' => ['type' => 'foreign', 'columns' => ['users_id'], 'references' => ['users', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'lugares_id' => 1,
            'perfilfb' => 'Lorem ipsum dolor sit amet',
